...
# include USERHOOK_VARIABLES
    ...
    void Log_Write_Guided_Position_Target(ModeCustom::SubMode submode, const Vector3p& pos_target_ned_m, bool is_terrain_alt, const Vector3f& vel_target_ms, const Vector3f& accel_target_mss);
    ...
    void Log_Write_Guided_Attitude_Target(ModeCustom::SubMode submode, float roll_rad, float pitch_rad, float yaw_rad, const Vector3f &ang_vel_rads, float thrust, float climb_rate_ms);
